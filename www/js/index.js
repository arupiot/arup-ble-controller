...
var app = {
    ...
    bindEvents: function() {
        ...
        dim.addEventListener('change', this.sendData, false);
        cct.addEventListener('change', this.sendData, false);
        hue.addEventListener('change', this.sendData, false);
    ...
    connect: function(e) {
        var deviceId = e.target.dataset.deviceId,
            onConnect = function() {
                ...
                dim.dataset.deviceId = deviceId;
                cct.dataset.deviceId = deviceId;
                hue.dataset.deviceId = deviceId;
                app.showDetailPage();
            };
    ...
    sendData: function(event) { // send data to rfduino
        ...
        var data = stringToBytes(event.target.id[0] + pad(event.target.value, 3));
